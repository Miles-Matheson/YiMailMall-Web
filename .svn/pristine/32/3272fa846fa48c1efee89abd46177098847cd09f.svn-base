...
//  YIMaiMall
//
//  Created by Miles on 2017/11/14.
...
@interface JumpWebController ()<WKNavigationDelegate,WKUIDelegate,UIScrollViewDelegate>
@property (nonatomic, strong) WKWebView *webView;
@property (nonatomic, strong) UIProgressView *progressView;
@property (nonatomic, assign) CGFloat delayTime;
@end

@implementation JumpWebController
...
-(WKWebView *)webView
{
    if (!_webView) {
        ...
        _webView = [[WKWebView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, self.view.bounds.size.height) configuration:config];
